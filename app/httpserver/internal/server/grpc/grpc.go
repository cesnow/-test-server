...
import (
	"kiyudesign.com/cesnow/light-server/app/httpserver/internal/server/grpc/service"
...
func New(svcCtx *svc.ServiceContext, c zrpc.RpcServerConf, srv gatewaypb.RpcGatewayServer) *zrpc.RpcServer {
