...
type RpcMetadata struct {
	...
	LangPack string   `protobuf:"bytes,21,opt,name=lang_pack,json=langPack,proto3" json:"lang_pack,omitempty"`
}
...
var file_rpc_metadata_proto_rawDesc = []byte{
	...
	0x6e, 0x67, 0x65, 0x22, 0x8d, 0x03, 0x0a, 0x0b, 0x52, 0x70, 0x63, 0x4d, 0x65, 0x74, 0x61, 0x64,
	...
	0x61, 0x6b, 0x65, 0x6f, 0x75, 0x74, 0x12, 0x1b, 0x0a, 0x09, 0x6c, 0x61, 0x6e, 0x67, 0x5f, 0x70,
	0x61, 0x63, 0x6b, 0x18, 0x15, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x6c, 0x61, 0x6e, 0x67, 0x50,
	0x61, 0x63, 0x6b, 0x42, 0x15, 0x5a, 0x13, 0x70, 0x6b, 0x67, 0x2f, 0x74, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x2f, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_rpc_metadata_proto_goTypes = []interface{}{
...
func file_rpc_metadata_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_rpc_metadata_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TakeoutMessageRange); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_rpc_metadata_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Takeout); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_rpc_metadata_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
